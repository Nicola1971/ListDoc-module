    ...
    buttons: {
		...
		action: function () {            
			...
			location.href = href="index.php?a=64";
    		 ...
    		 animation: \'top\',
			 theme: \''.$confirmTheme.'\',
			 title:\'' . $_lang["empty_recycle_bin"] . ' \'+trID,
			 content: \'' . $_lang["actioncomplete"] . '\',
			 useBootstrap: false,
    		 animation: \'top\',
			 });
